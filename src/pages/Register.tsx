...
const Register: React.FC = () => {
  ...
  const [role, setRole] = useState<'generator' | 'collector' | 'company'>('generator');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Welcome, you have successfully registered as a ${role.toUpperCase()}`);
      navigate('/');
    } catch (error) {
            ...
            <div>
              ...
              <div className="mt-1">
                <select
                  ...
                  name="role"
                  value={role}
                  onChange={(e) => setRole(e.target.value as 'generator' | 'collector' | 'company')}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                >
